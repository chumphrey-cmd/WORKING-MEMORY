...
> A living knowledge base and mono-repo that serves as my digital second brain. This repository contains information, tools, and techniques I am finding valuable throughout my InfoSec.
...
- [HARDENING](./BLUE-TEAM-WM/HARDENING/)
  ...
  - [UNIX](./BLUE-TEAM-WM/HARDENING/UNIX/)
    - Contains commands, hardening standards/procedures, and implementation guides for the Linux OS.
...
- [SIEMs](./BLUE-TEAM-WM/SIEMs/)
  - [ELASTIC](./BLUE-TEAM-WM/SIEMs/ELASTIC/)
    - Contains tips, tricks, insights, and practical threat hunting with Elastic.

  - [SPLUNK](./BLUE-TEAM-WM/SIEMs/SPLUNK/)
    - To be updated with tips, tricks, insights, and practical threat hunting with Splunk.

- [TRAINING DEV](./BLUE-TEAM-WM/TRAINING-DEV/)
  - Contains personal training that I have developed both for myself and other analysts.

### HOME-LAB

- [DETECTION LAB BUILD GUIDE](./HOME-LAB/Detection_Lab_Build_Guide.md)
  - Contains ongoing updates and procedures to configure, network, and deploy your own Detection Lab.

### LEARNING

- [LEARNING PROTOCOLS](./LEARNING/PROTOCOLS/)
  - Useful information and protocols I find highly relevant and useful.

### PROGRAMMING

- [CONCEPTS](./PROGRAMMING/CONCEPTS)
  - Serves a central repository for interesting software development and technology concepts/ideas that I come across.

- [LESSONS](./PROGRAMMING/LESSONS/)
  - A workspace for programming concepts, fundamentals, and general reflection on what I learn each day.
...
- [LLM WORKFLOW](./TOOLS/LLM-WORK-FLOW/)
  - Contains my personal playbook on AI-assisted programming development to extract the most out of the tool to become a power user.