...
* Autoruns by sysinternals practice, deployment, and write up
  * Practice with have autorunsc.exe run on each endpoint of my netowork and send, send the golden image to my SIEM and have detections in place that notify if there a autostart or application installed on the device that differs from the Autoruns baseline.

## Development of DevSecOps Deployment

## Practice of Hardening Automation via Ansible
